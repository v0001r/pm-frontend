...
import { b as useAuth, c as cn, f as getCurrentReturnTo, g as isSessionExpiryInFlight, n as Button, o as buildLoginSearch, p as homeFor, s as buttonVariants } from "./button-Du-Bk9Wl.mjs";
import { b as useNavigate, f as useRouterState, y as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { E as Moon, H as Inbox, N as LogOut, R as LayoutDashboard, T as PanelLeftClose, U as FolderKanban, a as UserRound, b as Search, ct as ChevronDown, d as Ticket, f as Sun, ft as Bell, k as Menu, n as Users, ot as ChevronRight, s as UserCog, t as X, ut as ChartColumn, v as Settings, w as PanelLeftOpen, x as Plus } from "../_libs/lucide-react.mjs";
import { _ as fullName, h as UserAvatar, n as Input } from "./primitives-BE889lfB.mjs";
...
import { a as DropdownMenuSeparator, c as PopoverContent, d as actions, f as categoryName, g as useStore, h as relativeTime, i as DropdownMenuLabel, l as PopoverTrigger, n as DropdownMenuContent, o as DropdownMenuTrigger, p as findUser, r as DropdownMenuItem, s as Popover, t as DropdownMenu } from "./store-Cwl19Diw.mjs";
import { a as Trigger, i as Root3, n as Portal, r as Provider, t as Content2$1 } from "../_libs/radix-ui__react-tooltip.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/guard-DY-g-DXD.js
...
var MIRAKI_LOGO_SRC = "/miraki-logo.png";
function BrandLogo({ variant = "full", className }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
		src: MIRAKI_LOGO_SRC,
		alt: "Miraki Technologies",
		className: cn("block object-contain object-left", variant === "full" ? "h-8 w-auto max-w-full" : "h-9 w-10 object-cover", className)
	});
}
var adminNav = [
	{
...
function isNavItemActive(item, pathname) {
	...
	if (item.exact) {
		if (to.endsWith("/dashboard")) {
			const sectionRoot = to.slice(0, -10) || "/";
...
function navItemClasses(active, collapsed) {
	return cn("relative flex items-center gap-2.5 rounded-md text-[13px] font-medium transition-all duration-150 focus-visible:ring-2 focus-visible:ring-sidebar-ring/40 focus-visible:outline-none", collapsed ? "justify-center px-2 py-2" : "px-3 py-2", active ? collapsed ? "bg-sidebar-accent text-sidebar-active-foreground" : "bg-sidebar-accent text-sidebar-active-foreground before:absolute before:left-0 before:top-1/2 before:h-5 before:w-0.5 before:-translate-y-1/2 before:rounded-full before:bg-primary" : "text-sidebar-foreground hover:bg-sidebar-accent/80 hover:text-sidebar-active-foreground");
}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
		...
		children: items.map((item) => {
			...
			const link = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(NavIcon, { icon: item.icon }), !collapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "truncate",
					children: item.label
				})]
			}, item.to);
...
function Brand({ collapsed = false }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: cn("flex h-14 items-center border-b border-sidebar-border", collapsed ? "justify-center px-2" : "px-4"),
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BrandLogo, {
			variant: collapsed ? "mark" : "full",
			className: collapsed ? "h-9" : "h-8 max-w-[168px]"
		})
	});
}
function useTheme() {
...
var crumbLinkAliases = {
	"/admin": "/admin/dashboard",
	"/staff": "/staff/dashboard",
	"/client": "/client/dashboard"
};
var resourceParents = /* @__PURE__ */ new Set([
	"users",
	"customers",
	"projects",
	"tickets",
...
function Breadcrumbs() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
		...
		children: parts.map((part, i) => {
			...
			const parent = i > 0 ? parts[i - 1] : void 0;
			const label = crumbLabelFor(part, parent);
			const last = i === parts.length - 1;
			const idPart = isResourceIdPart(part, parent);
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
				className: "flex min-w-0 items-center gap-1.5",
				children: [i > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRight, { className: "size-3.5 shrink-0 text-muted-foreground" }), last || idPart ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("kbd", {
				className: "pointer-events-none absolute top-1/2 right-2.5 hidden -translate-y-1/2 sm:inline-flex",
				children: "⌘K"
			}),
...
function NotificationBell() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Popover, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PopoverTrigger, {
		...
		align: "end",
		className: "w-88 p-0 shadow-raised",
...
function ProfileMenu() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenu, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownMenuTrigger, {
		...
		align: "end",
		className: "w-56 p-1.5 shadow-raised",
		children: [
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
					className: "glass sticky top-0 z-20 flex h-14 items-center gap-3 border-b border-border/60 px-4 sm:px-6",
					children: [
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
										to: user?.role === "Client" ? "/portal/tickets/new" : "/admin/tickets",
										search: user?.role === "Client" ? void 0 : { action: "create" },
...
//#endregion
export { SheetContent as _, AlertDialogCancel as a, SheetTitle as b, AlertDialogFooter as c, AlertDialogTrigger as d, BrandLogo as f, Sheet as g, RequireRole as h, AlertDialogAction as i, AlertDialogHeader as l, GuestRoute as m, AdminRoute as n, AlertDialogContent as o, ClientRoute as p, AlertDialog as r, AlertDialogDescription as s, AdminOrStaffRoute as t, AlertDialogTitle as u, SheetDescription as v, StaffRoute as x, SheetHeader as y };
