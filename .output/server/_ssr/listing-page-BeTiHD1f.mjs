...
import { d as SectionCard } from "./primitives-BneTjl1i.mjs";
...
import { g as PopoverTrigger, h as PopoverContent, m as Popover } from "./guard-BAnzMztv.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/listing-page-BeTiHD1f.js
...
function ListingCardHeader({ title, description, breadcrumbs, value, onChange, placeholder = "Search…", filterOpen, onFilterOpenChange, activeFilterCount = 0, onFilterApply, onFilterClear, filterContent, filterTitle = "Filters", showFilters = true, onExport, exportLabel = "Export", primaryAction, className }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: cn("flex flex-wrap items-center gap-3 border-b border-border bg-card px-4 py-3", className),
		children: [
