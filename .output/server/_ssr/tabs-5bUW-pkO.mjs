...
//#region node_modules/.nitro/vite/services/ssr/assets/tabs-5bUW-pkO.js
...
var TabsPanelTrigger = import_react.forwardRef(({ className, icon, title, description, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Trigger, {
	ref,
	className: cn("group flex min-w-[9.5rem] flex-1 items-start gap-3 border-r border-border px-4 py-4 text-left transition-colors last:border-r-0", "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2", "data-[state=active]:border-y-2 data-[state=active]:border-y-primary data-[state=active]:bg-primary-soft data-[state=active]:text-primary", "disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed", className),
	...props,
