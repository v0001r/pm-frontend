...
import { V as Inbox, ft as ArrowDownRight, k as Minus, ut as ArrowUpRight } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/primitives-rWqtcPGP.js
...
function TableSkeleton({ rows = 6, cols = 5 }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "flex gap-4 bg-muted/40 px-5 py-3",
...
//#endregion
export { PageHeader as a, SLA_MATRIX as c, SlaBadge as d, StatusBadge as f, fullName as h, PROJECT_STATUSES as i, STATUSES as l, UserAvatar as m, KpiCard as n, PriorityBadge as o, TableSkeleton as p, PRIORITIES as r, ProjectStatusBadge as s, EmptyState as t, SectionCard as u };
