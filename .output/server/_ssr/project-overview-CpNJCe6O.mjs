...
import { C as Plus, Q as Clock3, W as FolderKanban, _t as ArrowLeft, d as Trash2, f as Ticket, n as Users, o as UserPlus, pt as Building2, rt as CircleCheck, w as Pencil } from "../_libs/lucide-react.mjs";
...
import { $ as Table, F as DataTableActions, H as EntityCell, J as Select, L as DataTableIconButton, Q as SelectValue, X as SelectItem, Y as SelectContent, Z as SelectTrigger, et as TableBody, it as TableRow, nt as TableHead, rt as TableHeader, tt as TableCell, w as fetchTicketsPage } from "./router-DyQZnl_T.mjs";
import { t as Label } from "./label-cyeiyrNV.mjs";
import { t as Input } from "./input-DantDJEY.mjs";
import { a as AlertDialogCancel, c as AlertDialogFooter, i as AlertDialogAction, l as AlertDialogHeader, o as AlertDialogContent, r as AlertDialog, s as AlertDialogDescription, u as AlertDialogTitle } from "./guard-BCYPieem.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/project-overview-CpNJCe6O.js
...
function ProjectOverview({ projectId, mode }) {
	const { user } = useAuth();
	const queryClient = useQueryClient();
